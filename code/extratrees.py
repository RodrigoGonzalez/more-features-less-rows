...
SCORING = 'f1_macro'
version = 'final_'
modeltype = 'extratrees_' + str(RANDOM_STATE) + '_' + SCORING

print "\nSet hyperparameters"
n_components = [100]
n_estimators = [475, 500, 525, 550, 575, 600, 625, 650, 675, 700]
criterion=['gini']
max_features = ['log2']
...
pipe = Pipeline([('scl', StandardScaler()),
                 ('pca', PCA()),
                 ('clf', ExtraTreesClassifier(warm_start=True,
                                              bootstrap=True,
                                              oob_score=True,
...
cv_outer = StratifiedShuffleSplit(y, n_iter=5, test_size=0.2, random_state=RANDOM_STATE+1)
...
# mean_absolute_error 0 {'pca__n_components': 100, 'clf__max_depth': 7, 'clf__criterion': 'gini', 'clf__max_features': 'log2', 'clf__n_estimators': 550}
# f1 0 {'pca__n_components': 100, 'clf__max_depth': 7, 'clf__criterion': 'gini', 'clf__max_features': 'log2', 'clf__n_estimators': 475}
# log_loss 0 {'pca__n_components': 100, 'clf__max_depth': 7, 'clf__criterion': 'gini', 'clf__max_features': 'log2', 'clf__n_estimators': 525}
# roc_auc 0 {'pca__n_components': 100, 'clf__max_depth': 7, 'clf__criterion': 'gini', 'clf__max_features': 'log2', 'clf__n_estimators': 525}
