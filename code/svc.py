...
SCORING = 'f1'
version = 'final_'
modeltype = 'svc_' + str(RANDOM_STATE) + '_' + SCORING
...
cv_outer = StratifiedShuffleSplit(y, n_iter=5, test_size=0.2, random_state=RANDOM_STATE+5)
...
# mean_absolute_error 0 {'clf__gamma': 0.00021049041445120198, 'clf__shrinking': False, 'pca__n_components': 100, 'clf__coef0': 9.0, 'clf__kernel': 'poly'}
# f1 0 {'clf__gamma': 0.00021049041445120198, 'clf__shrinking': True, 'pca__n_components': 100, 'clf__coef0': 9.0, 'clf__kernel': 'poly'}
# log_loss 0 {'clf__max_features': 0.85, 'pca__n_components': 100, 'clf__n_estimators': 500, 'clf__max_samples': 0.9}
# roc_auc 0 {'clf__gamma': 0.01, 'clf__shrinking': True, 'pca__n_components': 100, 'clf__coef0': 9.0, 'clf__kernel': 'poly'}
