...
SCORING = "log_loss"
version = "final_"
model_type = "logit_normal" + str(RANDOM_STATE) + "_" + SCORING
...
param_grid = [{"pca__n_components": n_components, "clf__C": C}]
...
cv_outer = StratifiedShuffleSplit(y, test_size=0.2, random_state=RANDOM_STATE + 2)
